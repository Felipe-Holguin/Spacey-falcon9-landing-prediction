...
However, first stage recovery is not always successful. It may fail due to technical conditions, mission constraints, or strategic decisions where recovery is not attempted. Since reusing the first stage significantly reduces costs, the ability to predict whether it will land successfully becomes critical for estimating the true cost of a launch.
